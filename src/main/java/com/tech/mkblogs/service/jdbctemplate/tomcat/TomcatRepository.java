...
public class TomcatRepository {
	...
	public Account saveAccount(Account account) throws Exception {
		try {
			...
			tomcatJdbcTemplate.update(new PreparedStatementCreator() {
				@Override
		...
		try {
			...
			if (dbObjectOptional.isPresent()) {
				...
				log.info(SQLConstants.SQL_UPDATE);
				 tomcatJdbcTemplate.update(SQLConstants.SQL_UPDATE,values);
			} else {
	...
	public Optional<Account> getAccount(Integer id) throws Exception {
		try {
			...
			return tomcatJdbcTemplate.queryForObject(
	...
	public List<Account> getAllData() throws Exception {
		...
		return tomcatJdbcTemplate.query(
	...
	public Integer deleteById(Integer id) {
		...
		return tomcatJdbcTemplate.update(SQLConstants.SQL_DELETE,id);
	}
}
